...
〈getTallest - gets the picture with the largest height
∣getShortest - gets the picture with the smallest height
∣getWidest - gets the picture with the widest width
∣getNarrowest - gets the picture with the narrowest width
∣getLargest - gets the picture with the largest area (width * height)
∣getLargest - gets the picture with the largest extent (width + height)
∣getSmallest - gets the picture with the smallest area (width * height)
∣getSmallest - gets the picture with the smallest extent (width + height)
〉
