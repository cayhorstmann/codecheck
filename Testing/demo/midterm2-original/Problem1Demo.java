...
public class Problem1Demo
{
   public static void main(String[] args)
   {
      ...
      System.out.println(gallery.get〈Tall∣Short∣Wid∣Narrow∣Larg∣Larg∣Small∣Small〉est());
      System.out.println(Arrays.toString(gallery.get〈Height∣Width∣Area∣Perimeter∣Name〉s()));
      System.out.println(gallery.count〈Short∣Tall∣Wide∣Narrow∣Small∣Large〉());
      gallery.remove〈Wide∣Narrow∣Short∣Tall〉(〈128∣128∣100∣100〉);
